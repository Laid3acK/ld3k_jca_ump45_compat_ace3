...
class CfgAmmo
{
    ...
    class JCA_B_45ACP_Ball_UMP45: BulletBase // Winchester Law Enforcement .45 ACP +P 230gr, 990fps (302m/s) barrel length 5" https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
    {
        ...
        // ACE_ballisticCoefficients[]={0.193}; // 990fp/s 5", ICAO G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        // ACE_standardAtmosphere="ICAO";
        // ACE_ballisticCoefficients[]={0.187}; // 990fp/s 5", ASM G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        // ACE_standardAtmosphere="ASM";
        ACE_ballisticCoefficients[]={0.261}; // 1089fp/s 200mm, ICAO G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        ACE_standardAtmosphere="ICAO";
        // ACE_ballisticCoefficients[]={0.254}; // 1089fp/s 200mm, ASM G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        // ACE_standardAtmosphere="ASM";
        ACE_velocityBoundaries[]={};
        ACE_dragModel=1;
    ...
    class JCA_B_45ACP_Ball_UMP45_Tracer_Green: JCA_B_45ACP_Ball_UMP45
    {
        model="\A3\Weapons_f\Data\bullettracer\tracer_green";
    };
    class JCA_B_45ACP_Ball_UMP45_Tracer_Yellow: JCA_B_45ACP_Ball_UMP45
    {
        model="\A3\Weapons_f\Data\bullettracer\tracer_yellow";
    };
...
class CfgMagazines
{
    ...
    class JCA_25Rnd_45ACP_UMP_Mag: CA_Magazine
    {
        ...
        initSpeed=332; // according to ACE_muzzleVelocities UMP45 barrel 200mm ICAO conditions (15°C, 1013.25hPa, 0%), JCA 370
    };
